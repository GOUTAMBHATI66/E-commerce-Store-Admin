...
export interface ApiChildrenProductChildrenProduct
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nav_links: Attribute.Relation<
      'api::children-product.children-product',
      'manyToMany',
...
export interface ApiElectronicProductElectronicProduct
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Price: Attribute.Integer;
    nav_links: Attribute.Relation<
      'api::electronic-product.electronic-product',
      'manyToMany',
      'api::nav-link.nav-link'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiMenProductMenProduct extends Schema.CollectionType {
...
export interface ApiNavLinkNavLink extends Schema.CollectionType {
  ...
  attributes: {
    ...
    men_products: Attribute.Relation<
      'api::nav-link.nav-link',
      'manyToMany',
      'api::men-product.men-product'
    >;
    women_products: Attribute.Relation<
      'api::nav-link.nav-link',
      'manyToMany',
      'api::women-product.women-product'
    >;
    children_products: Attribute.Relation<
      'api::nav-link.nav-link',
      'manyToMany',
      'api::children-product.children-product'
    >;
    electronic_products: Attribute.Relation<
      'api::nav-link.nav-link',
      'manyToMany',
      'api::electronic-product.electronic-product'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::children-product.children-product': ApiChildrenProductChildrenProduct;
      'api::electronic-product.electronic-product': ApiElectronicProductElectronicProduct;
